...
def _generate_audio(prompt, negative_prompt, duration, num_steps, cfg_strength, seed):
...
def handler(job):
    ...
    try:
        wav_bytes = _generate_audio(prompt, negative_prompt, duration, num_steps, cfg_strength, seed)
